...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SEEDUser.show_shared_buildings'
        db.add_column(u'landing_seeduser', 'show_shared_buildings',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'SEEDUser.show_shared_buildings'
        db.delete_column(u'landing_seeduser', 'show_shared_buildings')
