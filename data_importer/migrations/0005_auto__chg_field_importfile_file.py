...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'data_importer_importfile', 'file', self.gf('django.db.models.fields.files.FileField')(max_length=500, null=True))

    def backwards(self, orm):

        # Changing field 'ImportFile.file'
        db.alter_column(u'data_importer_importfile', 'file', self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True))
