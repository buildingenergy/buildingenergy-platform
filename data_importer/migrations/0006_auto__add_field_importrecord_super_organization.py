...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ImportRecord.super_organization'
        db.add_column(u'data_importer_importrecord', 'super_organization',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='import_records', null=True, to=orm['orgs.Organization']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ImportRecord.super_organization'
        db.delete_column(u'data_importer_importrecord', 'super_organization_id')
