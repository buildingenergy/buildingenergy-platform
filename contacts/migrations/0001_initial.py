...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'contacts_contact', (
            ...
            ('email_address', self.gf('django.db.models.fields.CharField')(max_length=128, null=True, blank=True)),
            ('telephone_number', self.gf('django.db.models.fields.CharField')(max_length=128, null=True, blank=True)),
            ('super_organization', self.gf('django.db.models.fields.related.ForeignKey')(related_name='contacts', to=orm['orgs.Organization'])),
        ))
        db.send_create_signal(u'contacts', ['Contact'])

        # Adding M2M table for field building_snapshots on 'Contact'
        m2m_table_name = db.shorten_name(u'contacts_contact_building_snapshots')
        ...
        db.create_unique(m2m_table_name, ['contact_id', 'buildingsnapshot_id'])
    ...
    def backwards(self, orm):
        ...
        # Removing M2M table for field building_snapshots on 'Contact'
        db.delete_table(db.shorten_name(u'contacts_contact_building_snapshots'))
