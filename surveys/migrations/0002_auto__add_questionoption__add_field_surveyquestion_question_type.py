...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'surveys_questionoption', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('question', self.gf('django.db.models.fields.related.ForeignKey')(related_name='question_options', to=orm['surveys.SurveyQuestion'])),
            ('option', self.gf('django.db.models.fields.CharField')(max_length=20)),
        ))
        db.send_create_signal(u'surveys', ['QuestionOption'])

        # Adding field 'SurveyQuestion.question_type'
        db.add_column(u'surveys_surveyquestion', 'question_type',
    ...
    def backwards(self, orm):
        ...
        db.delete_table(u'surveys_questionoption')

        # Deleting field 'SurveyQuestion.question_type'
        db.delete_column(u'surveys_surveyquestion', 'question_type')
