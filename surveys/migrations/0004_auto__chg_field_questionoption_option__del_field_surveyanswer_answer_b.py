...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'QuestionOption.option'
        db.alter_column(u'surveys_questionoption', 'option', self.gf('django.db.models.fields.CharField')(max_length=100))
        # Deleting field 'SurveyAnswer.answer_bool'
        db.delete_column(u'surveys_surveyanswer', 'answer_bool')


    def backwards(self, orm):

        # Changing field 'QuestionOption.option'
        db.alter_column(u'surveys_questionoption', 'option', self.gf('django.db.models.fields.CharField')(max_length=20))
        # Adding field 'SurveyAnswer.answer_bool'
        db.add_column(u'surveys_surveyanswer', 'answer_bool',
