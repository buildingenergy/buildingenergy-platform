...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'SurveyBuilding'
        db.create_table(u'surveys_surveybuilding', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('canonical_building', self.gf('django.db.models.fields.related.ForeignKey')(related_name='survey_buildings', to=orm['seed.CanonicalBuilding'])),
            ('survey', self.gf('django.db.models.fields.related.ForeignKey')(related_name='survey_buildings', to=orm['surveys.Survey'])),
            ('date_collected', self.gf('django.db.models.fields.DateField')(auto_now=True, null=True, blank=True)),
            ('comment', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
            ('completion_time', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
        ))
        db.send_create_signal(u'surveys', ['SurveyBuilding'])

        # Adding unique constraint on 'SurveyBuilding', fields ['canonical_building', 'survey']
        db.create_unique(u'surveys_surveybuilding', ['canonical_building_id', 'survey_id'])

        # Deleting field 'Survey.comment'
        db.delete_column(u'surveys_survey', 'comment')

        # Deleting field 'Survey.date_collected'
        db.delete_column(u'surveys_survey', 'date_collected')

        # Deleting field 'Survey.completion_time'
        db.delete_column(u'surveys_survey', 'completion_time')
    ...
    def backwards(self, orm):
        # Removing unique constraint on 'SurveyBuilding', fields ['canonical_building', 'survey']
        db.delete_unique(u'surveys_surveybuilding', ['canonical_building_id', 'survey_id'])

        # Deleting model 'SurveyBuilding'
        db.delete_table(u'surveys_surveybuilding')

        # Adding field 'Survey.comment'
        db.add_column(u'surveys_survey', 'comment',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Survey.date_collected'
        db.add_column(u'surveys_survey', 'date_collected',
                      self.gf('django.db.models.fields.DateField')(auto_now=True, default=datetime.datetime(2014, 8, 8, 0, 0), blank=True),
                      keep_default=False)

        # Adding field 'Survey.completion_time'
        db.add_column(u'surveys_survey', 'completion_time',
    ...
    models = {
        ...
        u'surveys.survey': {
            ...
            'canonical_buildings': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'surveys'", 'to': u"orm['seed.CanonicalBuilding']", 'through': u"orm['surveys.SurveyBuilding']", 'blank': 'True', 'symmetrical': 'False', 'null': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'})
        },
        ...
        u'surveys.surveybuilding': {
            'Meta': {'ordering': "['survey', 'canonical_building']", 'unique_together': "(('canonical_building', 'survey'),)", 'object_name': 'SurveyBuilding'},
            'canonical_building': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'survey_buildings'", 'to': u"orm['seed.CanonicalBuilding']"}),
            'comment': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            'completion_time': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
            'date_collected': ('django.db.models.fields.DateField', [], {'auto_now': 'True', 'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'survey': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'survey_buildings'", 'to': u"orm['surveys.Survey']"})
        },
