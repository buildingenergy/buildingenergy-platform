...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'seed_timeseries', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('begin_time', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True)),
            ('end_time', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True)),
            ('reading', self.gf('django.db.models.fields.FloatField')(null=True)),
            ('cost', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=11, decimal_places=4)),
            ('meter', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='timeseries_data', null=True, to=orm['seed.Meter'])),
        ))
        db.send_create_signal(u'seed', ['TimeSeries'])

        # Adding model 'Meter'
        db.create_table(u'seed_meter', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('energy_type', self.gf('django.db.models.fields.IntegerField')(max_length=3)),
            ('energy_units', self.gf('django.db.models.fields.IntegerField')(max_length=3)),
        ))
        db.send_create_signal(u'seed', ['Meter'])

        # Adding M2M table for field building_snapshot on 'Meter'
        m2m_table_name = db.shorten_name(u'seed_meter_building_snapshot')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('meter', models.ForeignKey(orm[u'seed.meter'], null=False)),
            ('buildingsnapshot', models.ForeignKey(orm[u'seed.buildingsnapshot'], null=False))
        ))
        db.create_unique(m2m_table_name, ['meter_id', 'buildingsnapshot_id'])


    def backwards(self, orm):
        # Deleting model 'TimeSeries'
        db.delete_table(u'seed_timeseries')

        # Deleting model 'Meter'
        db.delete_table(u'seed_meter')

        # Removing M2M table for field building_snapshot on 'Meter'
        db.delete_table(db.shorten_name(u'seed_meter_building_snapshot'))
