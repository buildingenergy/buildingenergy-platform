...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Schema.organization'
        db.alter_column(u'seed_schema', 'organization_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['orgs.Organization']))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Schema.organization'
        raise RuntimeError("Cannot reverse this migration. 'Schema.organization' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration
        # Changing field 'Schema.organization'
        db.alter_column(u'seed_schema', 'organization_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['orgs.Organization']))
