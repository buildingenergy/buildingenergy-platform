...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Column.is_extra_data'
        db.add_column(u'seed_column', 'is_extra_data',
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Column.is_extra_data'
        db.delete_column(u'seed_column', 'is_extra_data')
