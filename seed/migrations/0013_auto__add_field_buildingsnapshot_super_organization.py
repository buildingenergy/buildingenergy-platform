...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'BuildingSnapshot.super_organization'
        db.add_column(u'seed_buildingsnapshot', 'super_organization',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='building_snapshots', null=True, to=orm['orgs.Organization']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'BuildingSnapshot.super_organization'
        db.delete_column(u'seed_buildingsnapshot', 'super_organization_id')
