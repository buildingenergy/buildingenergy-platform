...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CustomBuildingHeaders.super_organization'
        db.add_column(u'seed_custombuildingheaders', 'super_organization',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='custom_headers', null=True, to=orm['orgs.Organization']),
                      keep_default=False)

        # Adding field 'StatusLabel.super_organization'
        db.add_column(u'seed_statuslabel', 'super_organization',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='StatusLabels', null=True, to=orm['orgs.Organization']),
                      keep_default=False)

        # Adding field 'Project.super_organization'
        db.add_column(u'seed_project', 'super_organization',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='projects', null=True, to=orm['orgs.Organization']),
                      keep_default=False)

        # Adding field 'ColumnMapping.super_organization'
        db.add_column(u'seed_columnmapping', 'super_organization',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='column_mappings', null=True, to=orm['orgs.Organization']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CustomBuildingHeaders.super_organization'
        db.delete_column(u'seed_custombuildingheaders', 'super_organization_id')

        # Deleting field 'StatusLabel.super_organization'
        db.delete_column(u'seed_statuslabel', 'super_organization_id')

        # Deleting field 'Project.super_organization'
        db.delete_column(u'seed_project', 'super_organization_id')

        # Deleting field 'ColumnMapping.super_organization'
        db.delete_column(u'seed_columnmapping', 'super_organization_id')
    ...
    models = {
        ...
        u'orgs.organization': {
            'Meta': {'ordering': "['name']", 'object_name': 'Organization'},
            'child_org': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'parent_org'", 'null': 'True', 'to': u"orm['orgs.Organization']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '100'}),
