...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding index on 'BuildingSnapshot', fields ['custom_id_1']
        db.create_index(u'seed_buildingsnapshot', ['custom_id_1'])

        # Adding index on 'BuildingSnapshot', fields ['tax_lot_id']
        db.create_index(u'seed_buildingsnapshot', ['tax_lot_id'])

        # Adding index on 'BuildingSnapshot', fields ['address_line_2']
        db.create_index(u'seed_buildingsnapshot', ['address_line_2'])

        # Adding index on 'BuildingSnapshot', fields ['address_line_1']
        db.create_index(u'seed_buildingsnapshot', ['address_line_1'])

        # Adding index on 'BuildingSnapshot', fields ['confidence']
        db.create_index(u'seed_buildingsnapshot', ['confidence'])

        # Adding index on 'BuildingSnapshot', fields ['match_type']
        db.create_index(u'seed_buildingsnapshot', ['match_type'])

        # Adding index on 'BuildingSnapshot', fields ['pm_property_id']
        db.create_index(u'seed_buildingsnapshot', ['pm_property_id'])

        # Adding index on 'BuildingSnapshot', fields ['source_type']
        db.create_index(u'seed_buildingsnapshot', ['source_type'])

        # Adding index on 'Column', fields ['column_name']
        db.create_index(u'seed_column', ['column_name'])

        # Adding index on 'Schema', fields ['name']
        db.create_index(u'seed_schema', ['name'])

        # Adding index on 'Enum', fields ['enum_name']
        db.create_index(u'seed_enum', ['enum_name'])


    def backwards(self, orm):
        # Removing index on 'Enum', fields ['enum_name']
        db.delete_index(u'seed_enum', ['enum_name'])

        # Removing index on 'Schema', fields ['name']
        db.delete_index(u'seed_schema', ['name'])

        # Removing index on 'Column', fields ['column_name']
        db.delete_index(u'seed_column', ['column_name'])

        # Removing index on 'BuildingSnapshot', fields ['source_type']
        db.delete_index(u'seed_buildingsnapshot', ['source_type'])

        # Removing index on 'BuildingSnapshot', fields ['pm_property_id']
        db.delete_index(u'seed_buildingsnapshot', ['pm_property_id'])

        # Removing index on 'BuildingSnapshot', fields ['match_type']
        db.delete_index(u'seed_buildingsnapshot', ['match_type'])

        # Removing index on 'BuildingSnapshot', fields ['confidence']
        db.delete_index(u'seed_buildingsnapshot', ['confidence'])

        # Removing index on 'BuildingSnapshot', fields ['address_line_1']
        db.delete_index(u'seed_buildingsnapshot', ['address_line_1'])

        # Removing index on 'BuildingSnapshot', fields ['address_line_2']
        db.delete_index(u'seed_buildingsnapshot', ['address_line_2'])

        # Removing index on 'BuildingSnapshot', fields ['tax_lot_id']
        db.delete_index(u'seed_buildingsnapshot', ['tax_lot_id'])

        # Removing index on 'BuildingSnapshot', fields ['custom_id_1']
        db.delete_index(u'seed_buildingsnapshot', ['custom_id_1'])
