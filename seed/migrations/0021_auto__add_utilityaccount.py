...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'UtilityAccount'
        db.create_table(u'seed_utilityaccount', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('account_holder', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['contacts.Contact'], null=True, blank=True)),
            ('account_number', self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True)),
            ('canonical_building', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['seed.CanonicalBuilding'])),
            ('utility', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['seed.Utility'])),
        ))
        db.send_create_signal(u'seed', ['UtilityAccount'])


    def backwards(self, orm):
        # Deleting model 'UtilityAccount'
        db.delete_table(u'seed_utilityaccount')
    ...
    models = {
        ...
        u'seed.meter': {
            ...
            'business': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'meters'", 'null': 'True', 'to': u"orm['seed.Business']"}),
        ...
        u'seed.timeseries': {
            ...
            'occupancy': ('django.db.models.fields.DecimalField', [], {'null': 'True', 'max_digits': '5', 'decimal_places': '2'}),
            'reading': ('django.db.models.fields.FloatField', [], {'null': 'True'})
        },
        u'seed.utility': {
            'Meta': {'object_name': 'Utility'},
            'accounts': ('django.db.models.fields.related.ManyToManyField', [], {'to': u"orm['seed.CanonicalBuilding']", 'through': u"orm['seed.UtilityAccount']", 'symmetrical': 'False'}),
            'address': ('django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'}),
        ...
        u'seed.utilityaccount': {
            'Meta': {'object_name': 'UtilityAccount'},
            'account_holder': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['contacts.Contact']", 'null': 'True', 'blank': 'True'}),
            'account_number': ('django.db.models.fields.CharField', [], {'max_length': '100', 'null': 'True', 'blank': 'True'}),
            'canonical_building': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['seed.CanonicalBuilding']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'utility': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['seed.Utility']"})
        }
    }
