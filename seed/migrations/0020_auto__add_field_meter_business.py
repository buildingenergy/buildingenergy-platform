...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Meter.business'
        db.add_column(u'seed_meter', 'business',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='meters', null=True, to=orm['seed.Business']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Meter.business'
        db.delete_column(u'seed_meter', 'business_id')
