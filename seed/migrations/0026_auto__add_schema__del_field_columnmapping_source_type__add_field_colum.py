...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Schema'
        db.create_table(u'seed_schema', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(unique=True, max_length=50)),
            ('organization', self.gf('django.db.models.fields.related.ForeignKey')(related_name='schemas', to=orm['orgs.Organization'])),
            ('source_type', self.gf('django.db.models.fields.IntegerField')()),
        ))
        db.send_create_signal(u'seed', ['Schema'])
        ...
        db.add_column(u'seed_columnmapping', 'schema',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='column_mappings', null=True, to=orm['seed.Schema']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'Schema'
        db.delete_table(u'seed_schema')


        # User chose to not deal with backwards NULL issues for 'ColumnMapping.source_type'
        raise RuntimeError("Cannot reverse this migration. 'ColumnMapping.source_type' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration        # Adding field 'ColumnMapping.source_type'
    ...
    models = {
        ...
        u'seed.columnmapping': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'schema': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'column_mappings'", 'null': 'True', 'to': u"orm['seed.Schema']"}),
