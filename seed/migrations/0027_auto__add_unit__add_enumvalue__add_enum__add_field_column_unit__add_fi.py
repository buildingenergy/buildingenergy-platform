...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Unit'
        db.create_table(u'seed_unit', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('unit_name', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('unit_type', self.gf('django.db.models.fields.IntegerField')(default=1)),
        ))
        db.send_create_signal(u'seed', ['Unit'])

        # Adding model 'EnumValue'
        db.create_table(u'seed_enumvalue', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('value_name', self.gf('django.db.models.fields.CharField')(max_length=255)),
        ))
        db.send_create_signal(u'seed', ['EnumValue'])

        # Adding model 'Enum'
        db.create_table(u'seed_enum', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('enum_name', self.gf('django.db.models.fields.CharField')(max_length=255)),
        ))
        db.send_create_signal(u'seed', ['Enum'])

        # Adding M2M table for field enum_values on 'Enum'
        m2m_table_name = db.shorten_name(u'seed_enum_enum_values')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('enum', models.ForeignKey(orm[u'seed.enum'], null=False)),
            ('enumvalue', models.ForeignKey(orm[u'seed.enumvalue'], null=False))
        ))
        db.create_unique(m2m_table_name, ['enum_id', 'enumvalue_id'])

        # Adding field 'Column.unit'
        db.add_column(u'seed_column', 'unit',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['seed.Unit'], null=True, blank=True),
                      keep_default=False)

        # Adding field 'Column.enum'
        db.add_column(u'seed_column', 'enum',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['seed.Enum'], null=True, blank=True),
                      keep_default=False)

        # Deleting field 'Schema.source_type'
        db.delete_column(u'seed_schema', 'source_type')

        # Adding M2M table for field columns on 'Schema'
        m2m_table_name = db.shorten_name(u'seed_schema_columns')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('schema', models.ForeignKey(orm[u'seed.schema'], null=False)),
            ('column', models.ForeignKey(orm[u'seed.column'], null=False))
        ))
        db.create_unique(m2m_table_name, ['schema_id', 'column_id'])

        # Deleting field 'ColumnMapping.schema'
        db.delete_column(u'seed_columnmapping', 'schema_id')

        # Adding field 'ColumnMapping.source_type'
        db.add_column(u'seed_columnmapping', 'source_type',
    ...
    def backwards(self, orm):
        # Deleting model 'Unit'
        db.delete_table(u'seed_unit')

        # Deleting model 'EnumValue'
        db.delete_table(u'seed_enumvalue')

        # Deleting model 'Enum'
        db.delete_table(u'seed_enum')

        # Removing M2M table for field enum_values on 'Enum'
        db.delete_table(db.shorten_name(u'seed_enum_enum_values'))

        # Deleting field 'Column.unit'
        db.delete_column(u'seed_column', 'unit_id')

        # Deleting field 'Column.enum'
        db.delete_column(u'seed_column', 'enum_id')


        # User chose to not deal with backwards NULL issues for 'Schema.source_type'
        raise RuntimeError("Cannot reverse this migration. 'Schema.source_type' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration        # Adding field 'Schema.source_type'
        db.add_column(u'seed_schema', 'source_type',
                      self.gf('django.db.models.fields.IntegerField')(),
                      keep_default=False)

        # Removing M2M table for field columns on 'Schema'
        db.delete_table(db.shorten_name(u'seed_schema_columns'))

        # Adding field 'ColumnMapping.schema'
        db.add_column(u'seed_columnmapping', 'schema',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='column_mappings', null=True, to=orm['seed.Schema'], blank=True),
                      keep_default=False)

        # Deleting field 'ColumnMapping.source_type'
        db.delete_column(u'seed_columnmapping', 'source_type')
    ...
    models = {
        ...
        u'seed.enum': {
            ...
            'enum_name': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            'enum_values': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'to': u"orm['seed.EnumValue']", 'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'})
        },
        u'seed.enumvalue': {
        ...
        u'seed.schema': {
            ...
            'columns': ('django.db.models.fields.related.ManyToManyField', [], {'to': u"orm['seed.Column']", 'symmetrical': 'False'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'unique': 'True', 'max_length': '50'}),
            'organization': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'schemas'", 'to': u"orm['orgs.Organization']"})
        },
        u'seed.statuslabel': {
