...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'TimeSeries.occupancy'
        db.add_column(u'seed_timeseries', 'occupancy',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=5, decimal_places=2),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'TimeSeries.occupancy'
        db.delete_column(u'seed_timeseries', 'occupancy')
