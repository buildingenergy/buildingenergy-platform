...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Business.description'
        db.add_column(u'seed_business', 'description',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Business.unit_number'
        db.add_column(u'seed_business', 'unit_number',
                      self.gf('django.db.models.fields.CharField')(max_length=5, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Business.description'
        db.delete_column(u'seed_business', 'description')

        # Deleting field 'Business.unit_number'
        db.delete_column(u'seed_business', 'unit_number')
    ...
    models = {
        ...
        u'seed.business': {
            ...
            'unit_number': ('django.db.models.fields.CharField', [], {'max_length': '5', 'null': 'True', 'blank': 'True'})
        },
