...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'Column', fields ['organization', 'column_name', 'is_extra_data']
        db.create_unique(u'seed_column', ['organization_id', 'column_name', 'is_extra_data'])


    def backwards(self, orm):
        # Removing unique constraint on 'Column', fields ['organization', 'column_name', 'is_extra_data']
        db.delete_unique(u'seed_column', ['organization_id', 'column_name', 'is_extra_data'])
