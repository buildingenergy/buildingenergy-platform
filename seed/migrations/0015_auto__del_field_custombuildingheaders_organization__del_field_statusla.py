...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'CustomBuildingHeaders.organization'
        db.delete_column(u'seed_custombuildingheaders', 'organization_id')

        # Deleting field 'StatusLabel.organization'
        db.delete_column(u'seed_statuslabel', 'organization_id')

        # Adding unique constraint on 'StatusLabel', fields ['name', 'super_organization']
        db.create_unique(u'seed_statuslabel', ['name', 'super_organization_id'])

        # Deleting field 'Project.organization'
        db.delete_column(u'seed_project', 'organization_id')

        # Deleting field 'ColumnMapping.organization'
        db.delete_column(u'seed_columnmapping', 'organization_id')
    ...
    def backwards(self, orm):
        ...
        # Removing unique constraint on 'StatusLabel', fields ['name', 'super_organization']
        db.delete_unique(u'seed_statuslabel', ['name', 'super_organization_id'])
        ...
        # User chose to not deal with backwards NULL issues for 'CustomBuildingHeaders.organization'
        raise RuntimeError("Cannot reverse this migration. 'CustomBuildingHeaders.organization' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration        # Adding field 'CustomBuildingHeaders.organization'
        db.add_column(u'seed_custombuildingheaders', 'organization',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['organizations.Organization']),
                      keep_default=False)

        # Adding field 'StatusLabel.organization'
        db.add_column(u'seed_statuslabel', 'organization',
        ...
        db.add_column(u'seed_project', 'organization',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['organizations.Organization'], null=True, blank=True),
                      keep_default=False)

        # Adding field 'ColumnMapping.organization'
        db.add_column(u'seed_columnmapping', 'organization',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['organizations.Organization'], null=True, blank=True),
                      keep_default=False)
