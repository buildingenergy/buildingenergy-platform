...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'DataColumns', fields ['organization', 'column_name']
        db.delete_unique(u'seed_datacolumns', ['organization_id', 'column_name'])

        # Deleting model 'DataColumns'
        db.delete_table(u'seed_datacolumns')

        # Adding model 'DataColumn'
        db.create_table(u'seed_datacolumn', (
            ...
            ('is_bedes', self.gf('django.db.models.fields.BooleanField')(default=False)),
        ))
        db.send_create_signal(u'seed', ['DataColumn'])

        # Adding unique constraint on 'DataColumn', fields ['organization', 'column_name']
        db.create_unique(u'seed_datacolumn', ['organization_id', 'column_name'])


    def backwards(self, orm):
        # Removing unique constraint on 'DataColumn', fields ['organization', 'column_name']
        db.delete_unique(u'seed_datacolumn', ['organization_id', 'column_name'])

        # Adding model 'DataColumns'
        db.create_table(u'seed_datacolumns', (
            ('organization', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['orgs.Organization'])),
            ('is_bedes_compiant', self.gf('django.db.models.fields.BooleanField')(default=False)),
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('column_name', self.gf('django.db.models.fields.CharField')(max_length=255)),
        ))
        db.send_create_signal(u'seed', ['DataColumns'])

        # Adding unique constraint on 'DataColumns', fields ['organization', 'column_name']
        db.create_unique(u'seed_datacolumns', ['organization_id', 'column_name'])

        # Deleting model 'DataColumn'
        db.delete_table(u'seed_datacolumn')
