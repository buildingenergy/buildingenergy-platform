...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'seed_business', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('address', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True)),
            ('owner', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['contacts.Contact'], null=True, blank=True)),
            ('gross_floor_area', self.gf('django.db.models.fields.FloatField')(null=True, blank=True)),
        ))
        db.send_create_signal(u'seed', ['Business'])

        # Adding M2M table for field building_snapshot on 'Business'
        m2m_table_name = db.shorten_name(u'seed_business_building_snapshot')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('business', models.ForeignKey(orm[u'seed.business'], null=False)),
            ('buildingsnapshot', models.ForeignKey(orm[u'seed.buildingsnapshot'], null=False))
        ))
        db.create_unique(m2m_table_name, ['business_id', 'buildingsnapshot_id'])

        # Adding model 'Utility'
        db.create_table(u'seed_utility', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('address', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True)),
            ('utility_type', self.gf('django.db.models.fields.IntegerField')(max_length=3)),
        ))
        db.send_create_signal(u'seed', ['Utility'])

        # Adding M2M table for field business on 'Utility'
        m2m_table_name = db.shorten_name(u'seed_utility_business')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('utility', models.ForeignKey(orm[u'seed.utility'], null=False)),
            ('business', models.ForeignKey(orm[u'seed.business'], null=False))
        ))
        db.create_unique(m2m_table_name, ['utility_id', 'business_id'])

        # Adding M2M table for field building_snapshot on 'Utility'
        m2m_table_name = db.shorten_name(u'seed_utility_building_snapshot')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('utility', models.ForeignKey(orm[u'seed.utility'], null=False)),
            ('buildingsnapshot', models.ForeignKey(orm[u'seed.buildingsnapshot'], null=False))
        ))
        db.create_unique(m2m_table_name, ['utility_id', 'buildingsnapshot_id'])


    def backwards(self, orm):
        # Deleting model 'Business'
        db.delete_table(u'seed_business')

        # Removing M2M table for field building_snapshot on 'Business'
        db.delete_table(db.shorten_name(u'seed_business_building_snapshot'))

        # Deleting model 'Utility'
        db.delete_table(u'seed_utility')

        # Removing M2M table for field business on 'Utility'
        db.delete_table(db.shorten_name(u'seed_utility_business'))

        # Removing M2M table for field building_snapshot on 'Utility'
        db.delete_table(db.shorten_name(u'seed_utility_building_snapshot'))
    ...
    models = {
        ...
        u'contacts.contact': {
            ...
            'building_snapshots': ('django.db.models.fields.related.ManyToManyField', [], {'blank': 'True', 'related_name': "'contacts'", 'null': 'True', 'symmetrical': 'False', 'to': u"orm['seed.BuildingSnapshot']"}),
            ...
            'email_address': ('django.db.models.fields.CharField', [], {'max_length': '128', 'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            ...
            'super_organization': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'contacts'", 'to': u"orm['orgs.Organization']"}),
            'telephone_number': ('django.db.models.fields.CharField', [], {'max_length': '128', 'null': 'True', 'blank': 'True'})
        },
        ...
        u'seed.business': {
            ...
            'building_snapshot': ('django.db.models.fields.related.ManyToManyField', [], {'blank': 'True', 'related_name': "'businesses'", 'null': 'True', 'symmetrical': 'False', 'to': u"orm['seed.BuildingSnapshot']"}),
            'gross_floor_area': ('django.db.models.fields.FloatField', [], {'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '100'}),
            'owner': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['contacts.Contact']", 'null': 'True', 'blank': 'True'})
        },
        ...
        u'seed.columnmapping': {
            'Meta': {'unique_together': "(('super_organization', 'column_raw', 'source_type'),)", 'object_name': 'ColumnMapping'},
        ...
        u'seed.utility': {
            ...
            'address': ('django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'}),
            'building_snapshot': ('django.db.models.fields.related.ManyToManyField', [], {'blank': 'True', 'related_name': "'utilities'", 'null': 'True', 'symmetrical': 'False', 'to': u"orm['seed.BuildingSnapshot']"}),
            'business': ('django.db.models.fields.related.ManyToManyField', [], {'blank': 'True', 'related_name': "'utilities'", 'null': 'True', 'symmetrical': 'False', 'to': u"orm['seed.Business']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '100'}),
            'utility_type': ('django.db.models.fields.IntegerField', [], {'max_length': '3'})
        }
    }
