 ...
 */
angular.module('BE.seed.controller.admin', ['BE.seed.controller.menu'])
.controller('seed_admin_controller', [
  ...
  function($scope, user_service, organization_service, uploader_service, user_profile_payload) {
    ...
    /**
     * gets the available and set feautres for and org
     * @param  {[type]} org [description]
     * @return {[type]}     [description]
     */
    $scope.get_organizations_features = function (org) {
        $scope.org_user.features =  [
            {
                name: 'custom building template',
                value: true
            },
            {
                name: 'co-branding',
