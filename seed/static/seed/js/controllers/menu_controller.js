...
.controller('seed_menu_controller', [
  ...
  function(
    ...
    /**
     * opens the new building modal to create a building
     * 
     */
    $scope.open_new_building_modal = function() {
        var modalInstance = $modal.open({
            templateUrl: urls.static_url + 'seed/partials/new_building_modal.html',
