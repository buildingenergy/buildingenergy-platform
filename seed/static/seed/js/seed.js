...
angular.module('BE.seed.controllers', [
    ...
    'BE.seed.controller.new_building_modal',
    ...
    $routeProvider
        ...
        .when('/projects/:project_id/:building_id', {
            ...
            templateUrl: function (element, attrs) {
                if(window.BE.extra_declarations.is_america_saves_user) {
                    return static_url + 'seed/partials/building_survey_form.html';
                } else {
                    return static_url + 'seed/partials/building_detail.html';
                }
            },
        })
        .when('/buildings', {
