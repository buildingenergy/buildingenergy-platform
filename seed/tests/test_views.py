...
class BuildingDetailViewTests(TestCase):
    ...
    def test_create_building(self):
        """ tests the create_building view"""
        # arrange
        url = reverse_lazy("seed:create_building")
        post_data = {
            'building': {'property_name': 'Howard Inn'},
        ...
        # assert
        self.assertEqual(data['status'], 'success')
        self.assertEqual(data['building']['property_name'], 'Howard Inn')
        b = BuildingSnapshot.objects.get(pk=data['building']['id'])
        self.assertEqual(b.property_name, 'Howard Inn')
        self.assertNotEqual(b.canonical_building, None)
        self.assertEqual(b.canonical_building.canonical_snapshot, b)
        self.assertEqual(b.property_name_source, b)
